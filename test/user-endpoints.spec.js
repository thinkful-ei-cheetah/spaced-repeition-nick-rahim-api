      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          words: [
            ...
            { original: 'lavaplatos', translation: 'dishwasher' },
            { original: 'la iglesia', translation: 'church' },
            { original: 'lapanadería', translation: 'bakery' },
            { original: 'matemáticas', translation: 'math' },
            { original: 'escuela', translation: 'school' },
            { original: 'manta', translation: 'blanket' },
            { original: 'la camisa', translation: 'shirt' },
            { original: 'la cabra', translation: 'goat' },
            { original: 'la charca', translation: 'pond' },
            { original: 'la colina', translation: 'hill' },
            { original: 'el caballo', translation: 'horse' },
            { original: 'cascada', translation: 'waterfall' },
            { original: 'la montaña', translation: 'mountain' }
          ]
        };
        return supertest(app)
          .post('/api/user')
